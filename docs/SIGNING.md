...
## Artifact locations
- Windows: `dist/setup-RClash-*.exe` (Inno), `target/x86_64-pc-windows-msvc/release/rclash.exe` + `rclash-core.exe`
- macOS: `dist/RClash.dmg`, `target/*/release/rclash` + `rclash-core`
- Linux: `dist/*.deb/rpm/AppImage`
